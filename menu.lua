...
function Menu:getEntries()
  ...
  if self.phase == "action" and self.canOrder then
    return { "Se battre", "Ordonner", "Utiliser un objet", "Passer son tour" }
  end
...
function Menu:setCanOrder(canOrder)
  self.canOrder = canOrder == true
end
