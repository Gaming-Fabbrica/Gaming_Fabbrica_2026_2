...
function Effects:startHealAnimation(healer, target, mode)
  ...
  self.healAnimation = {
    ...
    applied = false,
    particles = {
      {angle = -2.70, driftX = -148, rise = 264, delay = 0.00, wobble = 24, speed = 14.4, scale = 1.90},
      {angle = -2.10, driftX = -116, rise = 288, delay = 0.06, wobble = 26, speed = 16.2, scale = 2.10},
      {angle = -1.56, driftX = -88, rise = 252, delay = 0.14, wobble = 24, speed = 15.4, scale = 1.80},
      {angle = -0.84, driftX = -48, rise = 276, delay = 0.04, wobble = 28, speed = 16.8, scale = 2.00},
      {angle = -0.16, driftX = -16, rise = 236, delay = 0.18, wobble = 22, speed = 14.8, scale = 1.70},
      {angle = 0.36, driftX = 20, rise = 268, delay = 0.10, wobble = 26, speed = 17.6, scale = 2.00},
      {angle = 0.92, driftX = 56, rise = 292, delay = 0.22, wobble = 28, speed = 15.2, scale = 2.16},
      {angle = 1.48, driftX = 92, rise = 256, delay = 0.30, wobble = 24, speed = 16.0, scale = 1.84},
      {angle = 2.04, driftX = 124, rise = 280, delay = 0.16, wobble = 26, speed = 15.0, scale = 2.04},
      {angle = 2.56, driftX = 156, rise = 272, delay = 0.36, wobble = 24, speed = 16.4, scale = 1.80},
    },
  }
end
